    ...
    <nav class="mx-auto max-w-5xl px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <button type="button"
                    ...
                    class="inline-flex items-center justify-center rounded-md p-2 text-gray-600 transition hover:bg-gray-100 hover:text-gray-900 sm:hidden">
        ...
        <ul id="mobile-menu"
            data-nav-menu
            class="hidden flex-col gap-1 pt-4 text-sm font-medium text-gray-600 sm:hidden">
            @foreach (config('portfolio.navigation') as $item)
                <li>
                    <a href="{{ $item['url'] }}"
                       data-nav-link
                       class="block rounded-md px-2 py-2 transition hover:bg-gray-100 hover:text-gray-900">
                        {{ $item['label'] }}
                    </a>
                </li>
            @endforeach
